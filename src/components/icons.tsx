...
export function WhatsappIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M17.47 14.38c-.29-.15-1.72-.85-1.99-.94-.27-.1-.46-.15-.66.15-.2.29-.76.94-.93 1.13-.17.2-.34.22-.63.07-.29-.15-1.22-.45-2.33-1.44-.86-.77-1.44-1.71-1.61-2-.17-.29-.02-.45.13-.6.13-.13.29-.34.44-.51.15-.17.2-.29.29-.49.1-.2.05-.37-.02-.51-.07-.15-.66-1.59-.9-2.18-.24-.57-.48-.5-.66-.5-.17-.01-.36-.01-.56-.01-.2 0-.51.07-.78.37-.27.29-1.02 1-1.02 2.43 0 1.43 1.04 2.82 1.19 3.01.15.2 2.05 3.13 4.96 4.39.69.3 1.23.48 1.65.61.69.22 1.32.19 1.82.11.55-.08 1.72-.7 1.96-1.38.24-.68.24-1.26.17-1.38-.07-.12-.27-.2-.56-.35Z" />
      <path d="M12.01 2.5c-5.24 0-9.5 4.24-9.5 9.46 0 1.67.44 3.3 1.28 4.73L2.5 21.5l4.94-1.27a9.53 9.53 0 0 0 4.57 1.16h.01c5.24 0 9.5-4.24 9.5-9.46 0-2.53-.99-4.9-2.79-6.69a9.5 9.5 0 0 0-6.72-2.74Zm0 17.29h-.01a7.9 7.9 0 0 1-4.02-1.1l-.29-.17-2.93.76.78-2.84-.19-.29a7.84 7.84 0 0 1-1.22-4.23c0-4.34 3.55-7.87 7.91-7.87a7.87 7.87 0 0 1 5.58 2.31 7.8 7.8 0 0 1 2.32 5.57c0 4.34-3.55 7.86-7.93 7.86Z" />
    </svg>
  );
}
