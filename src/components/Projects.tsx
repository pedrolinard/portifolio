...
const projects: Project[] = [
  {
    ...
    highlights: [
      ...
      "129 testes automatizados com Vitest (servidor Next.js real) + testes E2E com Playwright, CI no GitHub Actions",
    ],
  ...
  },
  {
    ...
    highlights: [
      ...
      "Relatórios em CSV: agenda diária e faturamento por serviço",
