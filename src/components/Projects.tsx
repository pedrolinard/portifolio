...
const projects: Project[] = [
  {
    ...
    highlights: [
      ...
      "146 testes automatizados com Vitest (servidor Next.js real) + testes E2E com Playwright, CI no GitHub Actions",
    ],
  ...
  },
  {
    ...
    highlights: [
      ...
      "Seed automático de dados, testes de integração com JUnit 5 e MockMvc e CI no GitHub Actions a cada push/PR",
    ],
