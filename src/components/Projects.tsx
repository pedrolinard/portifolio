...
const projects: Project[] = [
  {
    ...
    highlights: [
      ...
      "Primeiro passo como provedor de identidade multiaplicação: isolamento por cliente (aplicação), chave de assinatura RS256 rotacionável via JWKS sem deploy coordenado, passkeys e rate limit escopados por aplicação",
      "236 testes automatizados: 194 com Vitest (servidor Next.js real), 6 E2E com Playwright e 36 no serviço Django (pytest), CI no GitHub Actions",
    ],
